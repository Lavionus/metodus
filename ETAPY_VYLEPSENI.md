...
## 07 — Další čtyři vzory pro odlišné předměty: následuje

- [ ] **07a · ch9_ph:** názorné porovnávání pH, předpověď a ověření; navázat na hotovou opravu, prověřit také zápis neutralizačních rovnic.
- [ ] **07b · aj9_neprima_rec:** dialog a názorná proměna zájmen, adresáta, času a místa.
- [ ] **07c · d6_prameny:** skutečná ukázka pramene, autor/účel/doba a doložení závěru.
- [ ] **07d · inf6_tabulky:** editovatelná minitabulka, vzorec a změna výsledku po změně vstupu.

## 08 — Propojení výuky

- [ ] **08a · apps.js:** jednotná metadata cíle, typu aktivity a návazností na několika pilotních lekcích.
- [ ] **08b · přehled a osnova:** odlišit existenci aplikace od pokrytí výstupu; přidat jasné vstupy podle účelu.
- [ ] **08c · deník:** rozlišit počet pokusů, první správnou odpověď a podporu při řešení; nepřeceňovat procento úspěšnosti.
- [ ] **08d · učitelské nástroje:** jeden průchod lekce → aktivita na tabuli → pracovní list → závěrečná otázka.
