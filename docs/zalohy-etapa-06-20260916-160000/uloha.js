/* ============================================================
   ...
   Metodus (localStorage `metodus_posun`) a ovládá se tlačítkem, které se samo
...
const Uloha = (function () {
  ...
  const NASTAVENI_KLIC = 'metodus_posun';
  const TEMPA = {
  ...
  function vlozOvladani() {
    ...
    vysvetlivka.textContent = 'Platí pro všechna procvičování v Metodusu. Ručně se hodí, '
