...
- **Původ obrázků (požadavek uživatele):** všechny nové obrázky musí být generované, nebo pocházet ze zdroje s licencí umožňující volné šíření. U stažených souborů vždy doložit autora, zdroj, konkrétní licenci a splnit její podmínky; samotná dostupnost na internetu nestačí. U generovaných obrázků uchovat nástroj a zadání.
...
- **Obrázky:**
  - `IMG-00-02` ⚪ **B** · sada 11 ilustrací předmětů (kniha a pero, geometrické těleso a pravítko, glóbus, baňka, list s buňkou, lupa nad mapou, hrad, notebook, anglický a německý slovník, domek se stromem, atom) ve stejném stylu — dlaždice předmětů na přehledu a v osnově
    - ✅ Hotovo 22. 9. 2026: 11 karet `obsah/img/00/prehled-*.webp`, originály PNG a zadání `.prompt.txt`; [galerie a seznam](obsah/img/kapitola-7-1.html). Zapojeno do přehledu a osnovy; filtrování a výběr témat zachovány.
...
- **Popis:** Obrazový průvodce osmi hláskami AJ/NJ/FJ s generovanými řezy a vysvětlením polohy mluvidel. Původní poslechová hra zůstává vypnutá kvůli nevhodnému syntetickému hlasu.
- **Funkčnost:** přepínání osmi ilustračních karet, příklady slov, krátké pokusy a odkrývání odpovědí. Tlačítka fungují klávesnicí. Sdílený průvodce nabízí v anglické lekci pět hlásek a v NJ/FJ tři; poslechové ovládání zůstává skryté.
...
- **Obrázky:**
  - `IMG-aj-02` 🔴 **B** 🟡 · sada asi 120 karet slovíček ve 6 tématech (zvířata, jídlo a pití, dům a nábytek, škola, oblečení, rodina a lidé) — hotovo a zapojeno 38 karet: zvířata (12), jídlo (10), škola (9) a rodina (7); jednoznačný motiv, stejné světlo a okraj; **sdílet s `de_slovicka`, `fr_slovicka`, `cj1_pismena`**
...
| `IMG-aj-02` | B 🟡 | sada asi 120 karet slovíček ve 6 tématech (zvířata, jídlo a pití, dům a nábytek, škola, oblečení, rodina a lidé) — hotovo a zapojeno 38 karet: zvířata (12), jídlo (10), škola (9) a rodina (7); jednoznačný motiv, stejné světlo a okraj; **sdílet s `de_slovicka`, `fr_slovicka`, `cj1_pismena`** | [aj_slovicka](obsah/aj_slovicka.html) |
