...
- **Obrázky:**
  - `IMG-aj-02` 🔴 **B** 🟡 · sada asi 120 karet slovíček ve 6 tématech (zvířata, jídlo a pití, dům a nábytek, škola, oblečení, rodina a lidé) — hotovo 46 různých karet: zvířata (12), jídlo (10), škola (9), rodina (7) a dům a nábytek (9; židle sdílená se školou); domácí motivy zapojeny také v `de_slovicka` a `fr_slovicka`; jednoznačný motiv, stejné světlo a okraj
