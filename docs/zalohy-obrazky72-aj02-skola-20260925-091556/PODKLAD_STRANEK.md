...
- **Obrázky:**
  - `IMG-aj-02` 🔴 **B** 🟡 · sada asi 120 karet slovíček ve 6 tématech (zvířata, jídlo a pití, dům a nábytek, škola, oblečení, rodina a lidé) — hotovo a zapojeno 22 karet: zvířata (12) a jídlo (10); jednoznačný motiv, stejné světlo a okraj; **sdílet s `de_slovicka`, `fr_slovicka`, `cj1_pismena`**
...
| `IMG-aj-02` | B 🟡 | sada asi 120 karet slovíček ve 6 tématech (zvířata, jídlo a pití, dům a nábytek, škola, oblečení, rodina a lidé) — hotovo a zapojeno 22 karet: zvířata (12) a jídlo (10); jednoznačný motiv, stejné světlo a okraj; **sdílet s `de_slovicka`, `fr_slovicka`, `cj1_pismena`** | [aj_slovicka](obsah/aj_slovicka.html) |
