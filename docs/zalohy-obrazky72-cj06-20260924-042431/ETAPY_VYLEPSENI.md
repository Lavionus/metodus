...
- Všech 113 ilustrací má projektový PNG originál, WebP 768 × 768 px do 60 kB, přesné zadání, alt text a záznam původu v `obsah/img/kapitola-7-2.json`; souhrnná galerie je `obsah/img/kapitola-7-2.html`.
- Ověření: `tests/obrazky72-browser.mjs`, Chromium přes CDP; sedm stránek, 65 karet vyjmenovaných slov a čtyři scénky druhů vět, původní režimy, načtení obrázků, světlý i tmavý motiv a šířky 1280/390/320 px. Bez běhových JS výjimek a bez vodorovného přetékání; mobilní snímky byly vizuálně zkontrolovány. Cache zvýšena na v98. Veřejné nasazení neproběhlo.
