...
- Uložení: `obsah/img/cj/cj1-pismena-*.png`, `.webp` a `.prompt.txt`.
...
- Celkem 113 hotových ilustrací. Další sady kapitoly 7.2 pokračují podle pořadí v podkladovém dokumentu; historické doklady stylu E se nemají generovat.
