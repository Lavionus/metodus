...
- Uložení: `obsah/img/cj/` a `obsah/img/m/`; každý motiv jako `.png`, `.webp` a `.prompt.txt`.
- WebP: 768 × 768 px, každý nejvýše 60 000 B.
...
- Celkem 176 hotových ilustrací. Další sady kapitoly 7.2 pokračují podle pořadí v podkladovém dokumentu; historické doklady stylu E se nemají generovat.
