...
| nová sada úloh | **🔄 Nová série** | ▶️ Start, 🔄 Znovu, Hrát znovu, 🎲 Nový |
| nápověda k úloze | **💡 Nápověda** (stupňovaná: 1. nasměrování, 2. postup, 3. řešení) | 💡 Ukaž podmět, Nevím, ukaž řešení, 💡 Napovědět |
| návod k simulaci | **❓ Jak to ovládat** | ❓ Nápověda, ⓘ, ℹ️ Údaje |
| vrátit model | **↺ Výchozí stav** | ↺ Reset, 🔄 Restart proudění, 🧹 Uklidnit, 🌱 Nový rybník |
